...
class Memcached {
    ...
    /**
     * Client mode option, can set it to STATIC_CLIENT_MODE or DYNAMIC_CLIENT_MODE
     */
    const OPT_CLIENT_MODE;

    /**
     * Dynamic mode periodic polling threshold interval option
     */
    ...
    /**
     * Static client mode.
     * In this mode, the server list provided will be used as is.
     */
    const STATIC_CLIENT_MODE;

    /**
     * Dynamic client mode.
     * The server list expects 1 endpoint and the library will retrieve the server list dynamically at runtime.
     */
